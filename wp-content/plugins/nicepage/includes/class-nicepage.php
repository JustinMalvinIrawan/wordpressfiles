...
class Nicepage {
    ...
    public static function wpFooterAction() {
        ...
        if ($post && $renderPages) {
            ...
            if ($backlink && get_option('np_hide_backlink')) {
                    ...
                    function ($content) {
                        ...
                        $content[1] = preg_replace_callback(
                            ...
                            function ($content) {
                                ...
                                return $imageHtml = preg_replace('/(src=[\'"])([\s\S]+?)([\'"])/', '$1' . $url . '$3', $imageHtml);
                            },
                            $content[1]
                        );
                        $content[1] = preg_replace_callback(
                            ...
                            function ($content) {
                                ...
                                return preg_replace('/<!--blog_post_readmore_content-->([\s\S]+?)<!--\/blog_post_readmore_content-->/', sprintf(__('Read more', 'default')), $content[1]);
                            },
                            $content[1]
                        );
                        $content[1] = preg_replace_callback(
...
add_action('wp_footer', 'Nicepage::wpFooterAction', 1001);
